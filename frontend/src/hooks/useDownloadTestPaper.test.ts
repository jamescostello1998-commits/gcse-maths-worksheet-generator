...
import { useDownloadTestPaper } from './useDownloadTestPaper'

describe('useDownloadTestPaper', () => {
  beforeEach(() => {
    vi.restoreAllMocks()
  ...
  it('downloads the test paper on success', async () => {
    ...
    const { result } = renderHook(() => useDownloadTestPaper())
    await act(async () => {
